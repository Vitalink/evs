...
java -Dfile.encoding=UTF-8 -Dlog4j.configuration=file:../config/log4j/log4j-uploader.properties -cp "./datagenerator-%EVS_VERSION%.jar;./core-%EVS_VERSION%.jar;./ehconnector-%EVS_VERSION%.jar;./validator-%EVS_VERSION%.jar;./viewer-%EVS_VERSION%.jar;./dependency-jars/*;../config/actors/*" org.imec.ivlab.validator.BatchKmehrValidator %*
goto END
