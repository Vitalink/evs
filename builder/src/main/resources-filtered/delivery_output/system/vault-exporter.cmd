...
title EVS - Exporter ${pom.version}
...
JAVA -Xms1024M -Dfile.encoding=UTF-8 -Dlog4j.configurationFile=file:../config/log4j/log4j2-exporter.xml -cp "./datagenerator-%EVS_VERSION%.jar;./core-%EVS_VERSION%.jar;./ehconnector-%EVS_VERSION%.jar;./validator-%EVS_VERSION%.jar;./viewer-%EVS_VERSION%.jar;./dependency-jars/*;../config/actors/*" org.imec.ivlab.datagenerator.exporter.VaultExporterRunner %*
goto END
