...
public class R1001g_MultipleOfMonthsAllowedFields extends BaseMSEntryRule implements MSEntryRule {

    @Override
    public String getMessage() {
        return "When using a multiplier of months, only the date can be used";
    }
