...
public class R1001k_MultipleOfWeeksDayNumberValue extends BaseMSEntryRule implements MSEntryRule {

    @Override
    public String getMessage() {
        return "Daynumber should not be bigger than Week Multiplier";
    }
    ...
    public RuleExecution performValidation(MSEntry msEntry) {
        ...
        if (dayPeriod != null && dayNumbers != null) {
            ...
            for (BigInteger dayNumber : dayNumbers) {
                ...
                if (frequencyCode.hasFrequency(Frequency.WEEK) && dayNumber.intValue() > (frequencyCode.getMultiplier().intValue() * 7)) {
