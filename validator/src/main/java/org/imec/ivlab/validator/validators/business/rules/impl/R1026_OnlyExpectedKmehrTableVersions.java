...
public class R1026_OnlyExpectedKmehrTableVersions extends BaseKmehrMessageStringRule implements KmehrMessageStringRule, CustomMessage {

    private String customMessage = null;

    @Override
    public String getMessage() {
        return "An unexpected version of Kmehr table was used: ";
    }
    ...
    public RuleExecution performValidation(String kmehrMessageString) {
        ...
        for (Code code : codes) {
            if (!tableManager.isValidTableVersion(code.getS(), code.getSV())) {
                invalidTables.add(code.getSV() + " of " + code.getS());
            }
        }
