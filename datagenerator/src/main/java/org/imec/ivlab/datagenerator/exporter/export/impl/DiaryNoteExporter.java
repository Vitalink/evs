...
public class DiaryNoteExporter extends AbstractTransactionsExporter {
    ...
    public Writer<GetTransactionResponse> getWriter() {
        return new TransactionWriter(TransactionType.DIARY_NOTE, CDTRANSACTIONvalues.DIARYNOTE);
    }
