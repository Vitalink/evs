...
public class ChildPreventionExporter extends AbstractTransactionsExporter {
    ...
    public Writer<GetTransactionResponse> getWriter() {
        return new TransactionWriter(TransactionType.CHILD_PREVENTION, CDTRANSACTIONvalues.CHILD_PREVENTION);
    }
